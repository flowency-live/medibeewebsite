            ...
            {TEAM.map((member, index) => {
              ...
              return (
                ...
                >
                  {/* Image / Placeholder */}
                  <div
                    className={`relative aspect-[4/3] md:aspect-auto md:min-h-[400px] bg-void-medium ${isEven ? 'md:order-1' : 'md:order-2'}`}
                  >
                    {member.image ? (
                      <Image
                        src={member.image}
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center">
                        ...
                        >
                          ...
                          />
                          {/* Person silhouette */}
                          <circle cx="60" cy="45" r="18" fill="#D4AF37" fillOpacity="0.4" />
                          <path
                        ...
                        <span className="text-sm tracking-[0.1em] uppercase opacity-50 text-gold-soft">
                          Awaiting Photo
                        </span>
                      </div>
                    )}
                  ...
                  >
                    ...
                    <p className="text-xs uppercase tracking-[0.15em] mb-6 text-gold">
                      {member.role}
                    </p>
                    <p className="text-lg leading-relaxed opacity-85 text-pearl-soft">
                      {member.bio}
