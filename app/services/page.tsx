              ...
              <ul className="space-y-4">
                {SETTINGS.map((setting) => (
                  <li key={setting} className="flex items-start gap-3">
                    ...
                    <span className="font-body text-body-md text-ink">{setting}</span>
                  </li>
                ))}
              </ul>
            </div>

            <div className="bg-white p-8 border-l-[3px] border-rich-gold">
              <h3 className="font-display text-display-sm text-ink mb-4">
                Why choose Medibee?
              </h3>
              <ul className="space-y-4 font-body text-body-md text-deep-slate">
      ...
      <section className="section-spacing bg-white">
        <div className="container-editorial">
          <div className="max-w-3xl">
            ...
            <ul className="space-y-4 font-body text-body-md text-ink">
            ...
            <p className="font-body text-body-lg text-deep-slate mt-8">
      ...
      <section className="section-spacing">
        <div className="container-editorial">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-6 text-body-sm text-neutral-grey uppercase tracking-ui">
